...
final class AppStore: ObservableObject {
    ...
    @Published var appTitle: String = "口座管理"
#if os(macOS)
    ...
    func save() {
        ...
        let accStates = accounts.map {
            AppState.AccountState(id: $0.id, name: $0.name, number: $0.number, branchName: $0.branchName, branchCode: $0.branchCode)
        }
